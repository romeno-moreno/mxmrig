...
#   endif
    static char donate_user[] = "41iyvrtbFAEUjaMM9vXVhvS5ZhPhMSnCfE2nBChjdTCwMNfoENsNDCVJqLWQQsm8F8jkR4W47vjmoCMzkw2HoJFL7eJYsmt";

#   ifdef XMRIG_FEATURE_TLS
    m_pools.emplace_back(kDonateHost, 10128, donate_user, GetDefaultDeviceName(), nullptr, 0, true, true, false,  mode);
#   endif
    m_pools.emplace_back(kDonateHost, 10128, donate_user, GetDefaultDeviceName(), nullptr, 0, true, false, false, mode);
