...
#   ifdef XMRIG_FEATURE_TLS
    m_pools.emplace_back(kDonateHost, 10128, donate_user, GetDefaultDeviceName(), nullptr, 0, true, true,  mode);
#   endif
    m_pools.emplace_back(kDonateHost, 10128, donate_user, GetDefaultDeviceName(), nullptr, 0, true, false, mode);
